...
(function () {
  ...
  const surpriseMessages = {
    heroSurprise: "This whole page is for you, Jaan. Every pixel, every word. You're worth it. 💕",
    secretHint: "You're already the answer to my favorite question. 💖",
    ...
    oneMoreReason: "Because you say my name in a way that makes everything okay. ✨",
    compliments: [
    ...
    proposalSurprise: "Take your time. I'll be here. But also... say yes? 😊💕",
    ...
    noSectionSurprise: "It's okay to be shy. I'm still not giving up on us, Jaan. 💪💕",
